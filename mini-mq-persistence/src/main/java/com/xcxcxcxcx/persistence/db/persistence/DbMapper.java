...
public final class DbMapper implements PersistenceMapper<Message>{
    ...
    @Override
    public List<Message> prePullIfAbsent(String topicId, String consumerGroupId, String key, Integer pageNum, Integer pageSize) {
        return service.prePullIfAbsent(topicId, consumerGroupId, key, pageNum, pageSize);
    }
